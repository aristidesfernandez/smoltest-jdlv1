...
class EstablishmentResourceIT {
    ...
    void createEstablishment() throws Exception {
        ...
        assertThat(testEstablishment.getMunicipalityCode()).isEqualTo(DEFAULT_MUNICIPALITY_CODE);
        ...
        assertThat(testEstablishment.getActivityType()).isEqualTo(DEFAULT_ACTIVITY_TYPE);
    ...
    @Test
    @Transactional
    void getAllEstablishmentsByMunicipalityCodeIsEqualToSomething() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where municipalityCode equals to DEFAULT_MUNICIPALITY_CODE
        defaultEstablishmentShouldBeFound("municipalityCode.equals=" + DEFAULT_MUNICIPALITY_CODE);

        // Get all the establishmentList where municipalityCode equals to UPDATED_MUNICIPALITY_CODE
        defaultEstablishmentShouldNotBeFound("municipalityCode.equals=" + UPDATED_MUNICIPALITY_CODE);
    }

    @Test
    @Transactional
    void getAllEstablishmentsByMunicipalityCodeIsInShouldWork() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where municipalityCode in DEFAULT_MUNICIPALITY_CODE or UPDATED_MUNICIPALITY_CODE
        defaultEstablishmentShouldBeFound("municipalityCode.in=" + DEFAULT_MUNICIPALITY_CODE + "," + UPDATED_MUNICIPALITY_CODE);

        // Get all the establishmentList where municipalityCode equals to UPDATED_MUNICIPALITY_CODE
        defaultEstablishmentShouldNotBeFound("municipalityCode.in=" + UPDATED_MUNICIPALITY_CODE);
    }

    @Test
    @Transactional
    void getAllEstablishmentsByMunicipalityCodeIsNullOrNotNull() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where municipalityCode is not null
        defaultEstablishmentShouldBeFound("municipalityCode.specified=true");

        // Get all the establishmentList where municipalityCode is null
        defaultEstablishmentShouldNotBeFound("municipalityCode.specified=false");
    }

    @Test
    @Transactional
    void getAllEstablishmentsByMunicipalityCodeContainsSomething() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where municipalityCode contains DEFAULT_MUNICIPALITY_CODE
        defaultEstablishmentShouldBeFound("municipalityCode.contains=" + DEFAULT_MUNICIPALITY_CODE);

        // Get all the establishmentList where municipalityCode contains UPDATED_MUNICIPALITY_CODE
        defaultEstablishmentShouldNotBeFound("municipalityCode.contains=" + UPDATED_MUNICIPALITY_CODE);
    }

    @Test
    @Transactional
    void getAllEstablishmentsByMunicipalityCodeNotContainsSomething() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where municipalityCode does not contain DEFAULT_MUNICIPALITY_CODE
        defaultEstablishmentShouldNotBeFound("municipalityCode.doesNotContain=" + DEFAULT_MUNICIPALITY_CODE);

        // Get all the establishmentList where municipalityCode does not contain UPDATED_MUNICIPALITY_CODE
        defaultEstablishmentShouldBeFound("municipalityCode.doesNotContain=" + UPDATED_MUNICIPALITY_CODE);
    }
    ...
    @Test
    @Transactional
    void getAllEstablishmentsByActivityTypeIsEqualToSomething() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where activityType equals to DEFAULT_ACTIVITY_TYPE
        defaultEstablishmentShouldBeFound("activityType.equals=" + DEFAULT_ACTIVITY_TYPE);

        // Get all the establishmentList where activityType equals to UPDATED_ACTIVITY_TYPE
        defaultEstablishmentShouldNotBeFound("activityType.equals=" + UPDATED_ACTIVITY_TYPE);
    }

    @Test
    @Transactional
    void getAllEstablishmentsByActivityTypeIsInShouldWork() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where activityType in DEFAULT_ACTIVITY_TYPE or UPDATED_ACTIVITY_TYPE
        defaultEstablishmentShouldBeFound("activityType.in=" + DEFAULT_ACTIVITY_TYPE + "," + UPDATED_ACTIVITY_TYPE);

        // Get all the establishmentList where activityType equals to UPDATED_ACTIVITY_TYPE
        defaultEstablishmentShouldNotBeFound("activityType.in=" + UPDATED_ACTIVITY_TYPE);
    }

    @Test
    @Transactional
    void getAllEstablishmentsByActivityTypeIsNullOrNotNull() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where activityType is not null
        defaultEstablishmentShouldBeFound("activityType.specified=true");

        // Get all the establishmentList where activityType is null
        defaultEstablishmentShouldNotBeFound("activityType.specified=false");
    }

    @Test
    @Transactional
    void getAllEstablishmentsByActivityTypeContainsSomething() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where activityType contains DEFAULT_ACTIVITY_TYPE
        defaultEstablishmentShouldBeFound("activityType.contains=" + DEFAULT_ACTIVITY_TYPE);

        // Get all the establishmentList where activityType contains UPDATED_ACTIVITY_TYPE
        defaultEstablishmentShouldNotBeFound("activityType.contains=" + UPDATED_ACTIVITY_TYPE);
    }

    @Test
    @Transactional
    void getAllEstablishmentsByActivityTypeNotContainsSomething() throws Exception {
        // Initialize the database
        establishmentRepository.saveAndFlush(establishment);

        // Get all the establishmentList where activityType does not contain DEFAULT_ACTIVITY_TYPE
        defaultEstablishmentShouldNotBeFound("activityType.doesNotContain=" + DEFAULT_ACTIVITY_TYPE);

        // Get all the establishmentList where activityType does not contain UPDATED_ACTIVITY_TYPE
        defaultEstablishmentShouldBeFound("activityType.doesNotContain=" + UPDATED_ACTIVITY_TYPE);
    }
    ...
    @Test
    @Transactional
    void getAllEstablishmentsByIdOperatorIsEqualToSomething() throws Exception {
        Operator idOperator;
        if (TestUtil.findAll(em, Operator.class).isEmpty()) {
            establishmentRepository.saveAndFlush(establishment);
            idOperator = OperatorResourceIT.createEntity(em);
        } else {
            idOperator = TestUtil.findAll(em, Operator.class).get(0);
        }
        em.persist(idOperator);
        em.flush();
        establishment.setIdOperator(idOperator);
        establishmentRepository.saveAndFlush(establishment);
        Long idOperatorId = idOperator.getId();

        // Get all the establishmentList where idOperator equals to idOperatorId
        defaultEstablishmentShouldBeFound("idOperatorId.equals=" + idOperatorId);

        // Get all the establishmentList where idOperator equals to (idOperatorId + 1)
        defaultEstablishmentShouldNotBeFound("idOperatorId.equals=" + (idOperatorId + 1));
    }
    ...
    void putExistingEstablishment() throws Exception {
        ...
        assertThat(testEstablishment.getMunicipalityCode()).isEqualTo(UPDATED_MUNICIPALITY_CODE);
        ...
        assertThat(testEstablishment.getActivityType()).isEqualTo(UPDATED_ACTIVITY_TYPE);
