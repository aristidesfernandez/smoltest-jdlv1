...
class DeviceEstablishmentResourceIT {
    ...
    public static DeviceEstablishment createEntity(EntityManager em) {
        ...
        deviceEstablishment.setIdEstablishment(establishment);
    ...
    void createDeviceEstablishment() throws Exception {
        ...
        assertThat(testDeviceEstablishment.getSerial()).isEqualTo(DEFAULT_SERIAL);
    ...
    void checkSerialIsRequired() throws Exception {
        int databaseSizeBeforeTest = deviceEstablishmentRepository.findAll().size();
        // set the field null
        deviceEstablishment.setSerial(null);
    ...
    void getAllDeviceEstablishments() throws Exception {
        ...
        restDeviceEstablishmentMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(deviceEstablishment.getId().intValue())))
    ...
    void getDeviceEstablishment() throws Exception {
        ...
        restDeviceEstablishmentMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(deviceEstablishment.getId().intValue()))
    ...
    void getDeviceEstablishmentsByIdFiltering() throws Exception {
        ...
        Long id = deviceEstablishment.getId();

        defaultDeviceEstablishmentShouldBeFound("id.equals=" + id);
        defaultDeviceEstablishmentShouldNotBeFound("id.notEquals=" + id);

        defaultDeviceEstablishmentShouldBeFound("id.greaterThanOrEqual=" + id);
        defaultDeviceEstablishmentShouldNotBeFound("id.greaterThan=" + id);

        defaultDeviceEstablishmentShouldBeFound("id.lessThanOrEqual=" + id);
        defaultDeviceEstablishmentShouldNotBeFound("id.lessThan=" + id);
    }
    ...
    @Test
    @Transactional
    void getAllDeviceEstablishmentsBySerialIsEqualToSomething() throws Exception {
        // Initialize the database
        deviceEstablishmentRepository.saveAndFlush(deviceEstablishment);

        // Get all the deviceEstablishmentList where serial equals to DEFAULT_SERIAL
        defaultDeviceEstablishmentShouldBeFound("serial.equals=" + DEFAULT_SERIAL);

        // Get all the deviceEstablishmentList where serial equals to UPDATED_SERIAL
        defaultDeviceEstablishmentShouldNotBeFound("serial.equals=" + UPDATED_SERIAL);
    }

    @Test
    @Transactional
    void getAllDeviceEstablishmentsBySerialIsInShouldWork() throws Exception {
        // Initialize the database
        deviceEstablishmentRepository.saveAndFlush(deviceEstablishment);

        // Get all the deviceEstablishmentList where serial in DEFAULT_SERIAL or UPDATED_SERIAL
        defaultDeviceEstablishmentShouldBeFound("serial.in=" + DEFAULT_SERIAL + "," + UPDATED_SERIAL);

        // Get all the deviceEstablishmentList where serial equals to UPDATED_SERIAL
        defaultDeviceEstablishmentShouldNotBeFound("serial.in=" + UPDATED_SERIAL);
    }

    @Test
    @Transactional
    void getAllDeviceEstablishmentsBySerialIsNullOrNotNull() throws Exception {
        // Initialize the database
        deviceEstablishmentRepository.saveAndFlush(deviceEstablishment);

        // Get all the deviceEstablishmentList where serial is not null
        defaultDeviceEstablishmentShouldBeFound("serial.specified=true");

        // Get all the deviceEstablishmentList where serial is null
        defaultDeviceEstablishmentShouldNotBeFound("serial.specified=false");
    }

    @Test
    @Transactional
    void getAllDeviceEstablishmentsBySerialContainsSomething() throws Exception {
        // Initialize the database
        deviceEstablishmentRepository.saveAndFlush(deviceEstablishment);

        // Get all the deviceEstablishmentList where serial contains DEFAULT_SERIAL
        defaultDeviceEstablishmentShouldBeFound("serial.contains=" + DEFAULT_SERIAL);

        // Get all the deviceEstablishmentList where serial contains UPDATED_SERIAL
        defaultDeviceEstablishmentShouldNotBeFound("serial.contains=" + UPDATED_SERIAL);
    }

    @Test
    @Transactional
    void getAllDeviceEstablishmentsBySerialNotContainsSomething() throws Exception {
        // Initialize the database
        deviceEstablishmentRepository.saveAndFlush(deviceEstablishment);

        // Get all the deviceEstablishmentList where serial does not contain DEFAULT_SERIAL
        defaultDeviceEstablishmentShouldNotBeFound("serial.doesNotContain=" + DEFAULT_SERIAL);

        // Get all the deviceEstablishmentList where serial does not contain UPDATED_SERIAL
        defaultDeviceEstablishmentShouldBeFound("serial.doesNotContain=" + UPDATED_SERIAL);
    }
    ...
    @Test
    @Transactional
    void getAllDeviceEstablishmentsByIdEstablishmentIsEqualToSomething() throws Exception {
        ...
        em.flush();
        deviceEstablishment.setIdEstablishment(idEstablishment);
        deviceEstablishmentRepository.saveAndFlush(deviceEstablishment);
        Long idEstablishmentId = idEstablishment.getId();

        // Get all the deviceEstablishmentList where idEstablishment equals to idEstablishmentId
        defaultDeviceEstablishmentShouldBeFound("idEstablishmentId.equals=" + idEstablishmentId);

        // Get all the deviceEstablishmentList where idEstablishment equals to (idEstablishmentId + 1)
        defaultDeviceEstablishmentShouldNotBeFound("idEstablishmentId.equals=" + (idEstablishmentId + 1));
    }
    ...
    void getNonExistingDeviceEstablishment() throws Exception {
        // Get the deviceEstablishment
        restDeviceEstablishmentMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    void putExistingDeviceEstablishment() throws Exception {
        ...
        assertThat(testDeviceEstablishment.getSerial()).isEqualTo(UPDATED_SERIAL);
    ...
    void putNonExistingDeviceEstablishment() throws Exception {
        int databaseSizeBeforeUpdate = deviceEstablishmentRepository.findAll().size();
        deviceEstablishment.setId(count.incrementAndGet());
    ...
    void partialUpdateDeviceEstablishmentWithPatch() throws Exception {
        ...
        partialUpdatedDeviceEstablishment.departureAt(UPDATED_DEPARTURE_AT).deviceNumber(UPDATED_DEVICE_NUMBER);
    ...
    void deleteDeviceEstablishment() throws Exception {
        ...
        restDeviceEstablishmentMockMvc
            .perform(delete(ENTITY_API_URL_ID, deviceEstablishment.getId()).accept(MediaType.APPLICATION_JSON))
