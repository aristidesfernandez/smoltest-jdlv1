...
class DeviceEstablishmentResourceIT {
    ...
    public static DeviceEstablishment createEntity(EntityManager em) {
        ...
        deviceEstablishment.setEstablishment(establishment);
    ...
    @Test
    @Transactional
    void getAllDeviceEstablishmentsByEstablishmentIsEqualToSomething() throws Exception {
        Establishment establishment;
        if (TestUtil.findAll(em, Establishment.class).isEmpty()) {
            deviceEstablishmentRepository.saveAndFlush(deviceEstablishment);
            establishment = EstablishmentResourceIT.createEntity(em);
        ...
        // Get all the deviceEstablishmentList where establishment equals to establishmentId
        defaultDeviceEstablishmentShouldBeFound("establishmentId.equals=" + establishmentId);

        // Get all the deviceEstablishmentList where establishment equals to (establishmentId + 1)
        defaultDeviceEstablishmentShouldNotBeFound("establishmentId.equals=" + (establishmentId + 1));
    }
