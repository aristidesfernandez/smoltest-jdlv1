...
class CounterDeviceResourceIT {
    ...
    void getAllCounterDevicesByCounterCodeIsEqualToSomething() throws Exception {
        ...
        counterDeviceRepository.saveAndFlush(counterDevice);
        String counterCodeId = counterCode.getCounterCode();
        ...
        // Get all the counterDeviceList where counterCode equals to "invalid-id"
        defaultCounterDeviceShouldNotBeFound("counterCodeId.equals=" + "invalid-id");
    }
    ...
    void getAllCounterDevicesByIdDeviceIsEqualToSomething() throws Exception {
        ...
        counterDeviceRepository.saveAndFlush(counterDevice);
        UUID idDeviceId = idDevice.getId();
        ...
        // Get all the counterDeviceList where idDevice equals to UUID.randomUUID()
        defaultCounterDeviceShouldNotBeFound("idDeviceId.equals=" + UUID.randomUUID());
    }
