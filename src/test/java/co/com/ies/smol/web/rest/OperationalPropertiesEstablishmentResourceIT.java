...
class OperationalPropertiesEstablishmentResourceIT {
    ...
    public static OperationalPropertiesEstablishment createEntity(EntityManager em) {
        ...
        operationalPropertiesEstablishment.setIdEstablishment(establishment);
    ...
    @Test
    @Transactional
    void getAllOperationalPropertiesEstablishmentsByIdEstablishmentIsEqualToSomething() throws Exception {
        ...
        em.flush();
        operationalPropertiesEstablishment.setIdEstablishment(idEstablishment);
        operationalPropertiesEstablishmentRepository.saveAndFlush(operationalPropertiesEstablishment);
        Long idEstablishmentId = idEstablishment.getId();

        // Get all the operationalPropertiesEstablishmentList where idEstablishment equals to idEstablishmentId
        defaultOperationalPropertiesEstablishmentShouldBeFound("idEstablishmentId.equals=" + idEstablishmentId);

        // Get all the operationalPropertiesEstablishmentList where idEstablishment equals to (idEstablishmentId + 1)
        defaultOperationalPropertiesEstablishmentShouldNotBeFound("idEstablishmentId.equals=" + (idEstablishmentId + 1));
    }
