...
class MunicipalityResourceIT {
    ...
    @Test
    @Transactional
    void getAllMunicipalitiesByDepartmentIsEqualToSomething() throws Exception {
        ...
        // Get all the municipalityList where department equals to departmentId
        defaultMunicipalityShouldBeFound("departmentId.equals=" + departmentId);

        // Get all the municipalityList where department equals to (departmentId + 1)
        defaultMunicipalityShouldNotBeFound("departmentId.equals=" + (departmentId + 1));
    }
