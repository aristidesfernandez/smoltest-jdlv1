...
class InterfacingResourceIT {
    ...
    public static Interfacing createEntity(EntityManager em) {
        ...
        interfacing.setEstablishment(establishment);
        return interfacing;
    }
    ...
    @Test
    @Transactional
    void getAllInterfacingsByEstablishmentIsEqualToSomething() throws Exception {
        Establishment establishment;
        if (TestUtil.findAll(em, Establishment.class).isEmpty()) {
            interfacingRepository.saveAndFlush(interfacing);
            establishment = EstablishmentResourceIT.createEntity(em);
        ...
        // Get all the interfacingList where establishment equals to establishmentId
        defaultInterfacingShouldBeFound("establishmentId.equals=" + establishmentId);

        // Get all the interfacingList where establishment equals to (establishmentId + 1)
        defaultInterfacingShouldNotBeFound("establishmentId.equals=" + (establishmentId + 1));
    }
