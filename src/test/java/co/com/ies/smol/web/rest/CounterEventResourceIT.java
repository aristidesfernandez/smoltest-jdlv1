...
class CounterEventResourceIT {
    ...
    public static CounterEvent createEntity(EntityManager em) {
        ...
        counterEvent.setCounter(counterType);
        // Add required entity
    ...
    @Test
    @Transactional
    void getAllCounterEventsByCounterIsEqualToSomething() throws Exception {
        CounterType counter;
        if (TestUtil.findAll(em, CounterType.class).isEmpty()) {
            counterEventRepository.saveAndFlush(counterEvent);
        ...
        // Get all the counterEventList where counter equals to counterId
        defaultCounterEventShouldBeFound("counterId.equals=" + counterId);

        // Get all the counterEventList where counter equals to "invalid-id"
        defaultCounterEventShouldNotBeFound("counterId.equals=" + "invalid-id");
    }
