...
class CounterEventResourceIT {
    ...
    void getAllCounterEventsByCounterCodeIsEqualToSomething() throws Exception {
        ...
        // Get all the counterEventList where counterCode equals to "invalid-id"
        defaultCounterEventShouldNotBeFound("counterCodeId.equals=" + "invalid-id");
    }
    ...
    void getAllCounterEventsByIdEventDeviceIsEqualToSomething() throws Exception {
        ...
        counterEventRepository.saveAndFlush(counterEvent);
        UUID idEventDeviceId = idEventDevice.getId();
        ...
        // Get all the counterEventList where idEventDevice equals to UUID.randomUUID()
        defaultCounterEventShouldNotBeFound("idEventDeviceId.equals=" + UUID.randomUUID());
    }
