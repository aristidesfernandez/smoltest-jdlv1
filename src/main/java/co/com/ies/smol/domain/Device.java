...
public class Device implements Serializable {
    ...
    @ManyToOne(optional = false)
    @NotNull
    @JsonIgnoreProperties(value = { "manufacturer", "formula", "idModels" }, allowSetters = true)
    private Model model;
    ...
    @ManyToOne
    private CurrencyType urrencyType;
    ...
    public Device interfacing(Interfacing interfacing) {
        this.setInterfacing(interfacing);
        return this;
    }
    ...
    public Device island(Island island) {
        this.setIsland(island);
        return this;
    }

    public CurrencyType getUrrencyType() {
        return this.urrencyType;
    }

    public void setUrrencyType(CurrencyType currencyType) {
        this.urrencyType = currencyType;
    }

    public Device urrencyType(CurrencyType currencyType) {
        this.setUrrencyType(currencyType);
        return this;
    }
