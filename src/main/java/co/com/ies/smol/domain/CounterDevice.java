...
public class CounterDevice implements Serializable {
    ...
    @JsonIgnoreProperties(
        value = { "interfacing", "model", "deviceCategory", "deviceType", "formulaHandpay", "formulaJackpot", "island", "urrencyType" },
        allowSetters = true
    )
    ...
    public void setCounter(CounterType counterType) {
        this.counter = counterType;
    }

    public CounterDevice counter(CounterType counterType) {
        this.setCounter(counterType);
        return this;
    }
