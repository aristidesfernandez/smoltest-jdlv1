...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, co.com.ies.smol.domain.EventType.class.getName() + ".idEventTypes");
            ...
            createCache(cm, co.com.ies.smol.domain.Island.class.getName());
            ...
            createCache(cm, co.com.ies.smol.domain.Model.class.getName() + ".idModels");
            createCache(cm, co.com.ies.smol.domain.Interfacing.class.getName());
            ...
            createCache(cm, co.com.ies.smol.domain.Department.class.getName());
