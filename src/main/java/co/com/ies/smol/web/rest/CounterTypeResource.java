...
public class CounterTypeResource {
    ...
    public ResponseEntity<CounterTypeDTO> createCounterType(@RequestBody CounterTypeDTO counterTypeDTO) throws URISyntaxException {
    ...
    public ResponseEntity<CounterTypeDTO> updateCounterType(
        ...
        @RequestBody CounterTypeDTO counterTypeDTO
