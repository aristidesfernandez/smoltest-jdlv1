...
public class DeviceEstablishmentResource {
    ...
    public ResponseEntity<DeviceEstablishmentDTO> getDeviceEstablishment(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deleteDeviceEstablishment(@PathVariable Long id) {
