...
public class DeviceDTO implements Serializable {
    ...
    private InterfacingDTO interfacing;
    ...
    private CurrencyTypeDTO urrencyType;
    ...
    public InterfacingDTO getInterfacing() {
        return interfacing;
    }

    public void setInterfacing(InterfacingDTO interfacing) {
    ...
    public void setIsland(IslandDTO island) {
        this.island = island;
    }

    public CurrencyTypeDTO getUrrencyType() {
        return urrencyType;
    }

    public void setUrrencyType(CurrencyTypeDTO urrencyType) {
        this.urrencyType = urrencyType;
    }
