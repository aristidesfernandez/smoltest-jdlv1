...
public class DeviceDTO implements Serializable {
    ...
    private InterfacingDTO idInterfacing;

    private ModelDTO idModel;

    private DeviceCategoryDTO idDeviceCategory;

    private DeviceTypeDTO idDeviceType;

    private FormulaDTO idFormulaHandpay;

    private FormulaDTO idFormulaJackpot;

    private IslandDTO idIsland;

    private CurrencyTypeDTO idCurrencyType;
    ...
    public InterfacingDTO getIdInterfacing() {
        return idInterfacing;
    }

    public void setIdInterfacing(InterfacingDTO idInterfacing) {
        this.idInterfacing = idInterfacing;
    }

    public ModelDTO getIdModel() {
        return idModel;
    }

    public void setIdModel(ModelDTO idModel) {
        this.idModel = idModel;
    }

    public DeviceCategoryDTO getIdDeviceCategory() {
        return idDeviceCategory;
    }

    public void setIdDeviceCategory(DeviceCategoryDTO idDeviceCategory) {
        this.idDeviceCategory = idDeviceCategory;
    }

    public DeviceTypeDTO getIdDeviceType() {
        return idDeviceType;
    }

    public void setIdDeviceType(DeviceTypeDTO idDeviceType) {
        this.idDeviceType = idDeviceType;
    }

    public FormulaDTO getIdFormulaHandpay() {
        return idFormulaHandpay;
    }

    public void setIdFormulaHandpay(FormulaDTO idFormulaHandpay) {
        this.idFormulaHandpay = idFormulaHandpay;
    }

    public FormulaDTO getIdFormulaJackpot() {
        return idFormulaJackpot;
    }

    public void setIdFormulaJackpot(FormulaDTO idFormulaJackpot) {
        this.idFormulaJackpot = idFormulaJackpot;
    }

    public IslandDTO getIdIsland() {
        return idIsland;
    }

    public void setIdIsland(IslandDTO idIsland) {
        this.idIsland = idIsland;
    }

    public CurrencyTypeDTO getIdCurrencyType() {
        return idCurrencyType;
    }

    public void setIdCurrencyType(CurrencyTypeDTO idCurrencyType) {
    ...
    public String toString() {
        return "DeviceDTO{" +
            ...
            ", idInterfacing=" + getIdInterfacing() +
            ", idModel=" + getIdModel() +
            ", idDeviceCategory=" + getIdDeviceCategory() +
            ", idDeviceType=" + getIdDeviceType() +
            ", idFormulaHandpay=" + getIdFormulaHandpay() +
            ", idFormulaJackpot=" + getIdFormulaJackpot() +
            ", idIsland=" + getIdIsland() +
            ", idCurrencyType=" + getIdCurrencyType() +
            "}";
    }
}
