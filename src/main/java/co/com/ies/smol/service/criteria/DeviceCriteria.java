...
public class DeviceCriteria implements Serializable, Criteria {
    ...
    private LongFilter interfacingId;
    ...
    private LongFilter islandId;

    private LongFilter urrencyTypeId;
    ...
    public DeviceCriteria(DeviceCriteria other) {
        ...
        this.interfacingId = other.interfacingId == null ? null : other.interfacingId.copy();
        ...
        this.islandId = other.islandId == null ? null : other.islandId.copy();
        this.urrencyTypeId = other.urrencyTypeId == null ? null : other.urrencyTypeId.copy();
    ...
    public LongFilter getInterfacingId() {
        return interfacingId;
    }

    public LongFilter interfacingId() {
        if (interfacingId == null) {
            interfacingId = new LongFilter();
        }
        return interfacingId;
    }

    public void setInterfacingId(LongFilter interfacingId) {
        this.interfacingId = interfacingId;
    }
    ...
    public LongFilter getIslandId() {
        return islandId;
    }

    public LongFilter islandId() {
        if (islandId == null) {
            islandId = new LongFilter();
        }
        return islandId;
    }

    public void setIslandId(LongFilter islandId) {
        this.islandId = islandId;
    }

    public LongFilter getUrrencyTypeId() {
        return urrencyTypeId;
    }

    public LongFilter urrencyTypeId() {
        if (urrencyTypeId == null) {
            urrencyTypeId = new LongFilter();
        }
        return urrencyTypeId;
    }

    public void setUrrencyTypeId(LongFilter urrencyTypeId) {
        this.urrencyTypeId = urrencyTypeId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(interfacingId, that.interfacingId) &&
            ...
            Objects.equals(urrencyTypeId, that.urrencyTypeId) &&
    ...
    public String toString() {
        return "DeviceCriteria{" +
            ...
            (interfacingId != null ? "interfacingId=" + interfacingId + ", " : "") +
            ...
            (islandId != null ? "islandId=" + islandId + ", " : "") +
            (urrencyTypeId != null ? "urrencyTypeId=" + urrencyTypeId + ", " : "") +
