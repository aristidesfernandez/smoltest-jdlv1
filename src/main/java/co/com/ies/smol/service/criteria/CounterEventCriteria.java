...
public class CounterEventCriteria implements Serializable, Criteria {
    ...
    public StringFilter getCounterId() {
        return counterId;
    }

    public StringFilter counterId() {
        if (counterId == null) {
            counterId = new StringFilter();
        }
        return counterId;
    }

    public void setCounterId(StringFilter counterId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, valueCounter, denominationSale, counterId, eventDeviceId, distinct);
    }
