...
public class CounterEventCriteria implements Serializable, Criteria {
    ...
    private StringFilter counterCodeId;

    private UUIDFilter idEventDeviceId;
    ...
    public StringFilter getCounterCodeId() {
        return counterCodeId;
    }

    public StringFilter counterCodeId() {
        if (counterCodeId == null) {
            counterCodeId = new StringFilter();
        }
        return counterCodeId;
    }

    public void setCounterCodeId(StringFilter counterCodeId) {
        this.counterCodeId = counterCodeId;
    }

    public UUIDFilter getIdEventDeviceId() {
        return idEventDeviceId;
    }

    public UUIDFilter idEventDeviceId() {
        if (idEventDeviceId == null) {
            idEventDeviceId = new UUIDFilter();
        }
        return idEventDeviceId;
    }

    public void setIdEventDeviceId(UUIDFilter idEventDeviceId) {
