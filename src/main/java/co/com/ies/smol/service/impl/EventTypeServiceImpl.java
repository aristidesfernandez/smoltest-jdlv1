...
public class EventTypeServiceImpl implements EventTypeService {
    ...
    public Page<EventTypeDTO> findAllWithEagerRelationships(Pageable pageable) {
        return eventTypeRepository.findAllWithEagerRelationships(pageable).map(eventTypeMapper::toDto);
    }
    ...
    public Optional<EventTypeDTO> findOne(Long id) {
        ...
        return eventTypeRepository.findOneWithEagerRelationships(id).map(eventTypeMapper::toDto);
    }
