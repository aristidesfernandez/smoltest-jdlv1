...
public class CounterDeviceCriteria implements Serializable, Criteria {
    ...
    public UUIDFilter getIdDeviceId() {
        return idDeviceId;
    }

    public UUIDFilter idDeviceId() {
        if (idDeviceId == null) {
            idDeviceId = new UUIDFilter();
        }
        return idDeviceId;
    }

    public void setIdDeviceId(UUIDFilter idDeviceId) {
