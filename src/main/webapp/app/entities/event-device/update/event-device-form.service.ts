...
type EventDeviceFormGroupContent = {
  ...
  idEstablishment: FormControl<EventDeviceFormRawValue['idEstablishment']>;
  idEventType: FormControl<EventDeviceFormRawValue['idEventType']>;
};
...
export class EventDeviceFormService {
  createEventDeviceFormGroup(eventDevice: EventDeviceFormGroupInput = { id: null }): EventDeviceFormGroup {
    ...
    return new FormGroup<EventDeviceFormGroupContent>({
      ...
      idEstablishment: new FormControl(eventDeviceRawValue.idEstablishment, {
        validators: [Validators.required],
      }),
      idEventType: new FormControl(eventDeviceRawValue.idEventType, {
        validators: [Validators.required],
      }),
    });
  }
