...
type DepartmentFormGroupContent = {
  ...
  daneCode: FormControl<IDepartment['daneCode']>;
  phoneId: FormControl<IDepartment['phoneId']>;
  country: FormControl<IDepartment['country']>;
};
...
export class DepartmentFormService {
  createDepartmentFormGroup(department: DepartmentFormGroupInput = { id: null }): DepartmentFormGroup {
    ...
    return new FormGroup<DepartmentFormGroupContent>({
      ...
      daneCode: new FormControl(departmentRawValue.daneCode, {
        validators: [Validators.maxLength(25)],
      }),
      phoneId: new FormControl(departmentRawValue.phoneId, {
        validators: [Validators.maxLength(15)],
      }),
      country: new FormControl(departmentRawValue.country),
    });
  }
