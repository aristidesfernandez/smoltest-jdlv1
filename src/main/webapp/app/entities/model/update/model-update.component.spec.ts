...
describe('Model Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Manufacturer query and add missing value', () => {
      ...
      const idManufacturer: IManufacturer = { id: 58997 };
      model.idManufacturer = idManufacturer;
      ...
      const additionalManufacturers = [idManufacturer];
    ...
    it('Should call Formula query and add missing value', () => {
      const model: IModel = { id: 456 };
      const idFormula: IFormula = { id: 12952 };
      model.idFormula = idFormula;
      ...
      const additionalFormulas = [idFormula];
    ...
    it('Should update editForm', () => {
      const model: IModel = { id: 456 };
      const idManufacturer: IManufacturer = { id: 42892 };
      model.idManufacturer = idManufacturer;
      const idFormula: IFormula = { id: 30057 };
      model.idFormula = idFormula;

      activatedRoute.data = of({ model });
      comp.ngOnInit();

      expect(comp.manufacturersSharedCollection).toContain(idManufacturer);
      expect(comp.formulasSharedCollection).toContain(idFormula);
