...
export class ModelUpdateComponent implements OnInit {
  ...
  protected loadRelationshipsOptions(): void {
    this.manufacturerService
      ...
      .pipe(
        map((manufacturers: IManufacturer[]) =>
          this.manufacturerService.addManufacturerToCollectionIfMissing<IManufacturer>(manufacturers, this.model?.idManufacturer)
        )
      )
    ...
    this.formulaService
      ...
      .pipe(map((formulas: IFormula[]) => this.formulaService.addFormulaToCollectionIfMissing<IFormula>(formulas, this.model?.idFormula)))
