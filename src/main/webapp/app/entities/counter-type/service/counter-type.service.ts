...
export type PartialUpdateCounterType = Partial<ICounterType> & Pick<ICounterType, 'id'>;
...
export class CounterTypeService {
  ...
  getCounterTypeIdentifier(counterType: Pick<ICounterType, 'id'>): number {
    return counterType.id;
  }

  compareCounterType(o1: Pick<ICounterType, 'id'> | null, o2: Pick<ICounterType, 'id'> | null): boolean {
    return o1 && o2 ? this.getCounterTypeIdentifier(o1) === this.getCounterTypeIdentifier(o2) : o1 === o2;
  }

  addCounterTypeToCollectionIfMissing<Type extends Pick<ICounterType, 'id'>>(
