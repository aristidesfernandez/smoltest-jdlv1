...
type DeviceFormGroupContent = {
  ...
  idInterfacing: FormControl<DeviceFormRawValue['idInterfacing']>;
  idModel: FormControl<DeviceFormRawValue['idModel']>;
  idDeviceCategory: FormControl<DeviceFormRawValue['idDeviceCategory']>;
  idDeviceType: FormControl<DeviceFormRawValue['idDeviceType']>;
  idFormulaHandpay: FormControl<DeviceFormRawValue['idFormulaHandpay']>;
  idFormulaJackpot: FormControl<DeviceFormRawValue['idFormulaJackpot']>;
  idIsland: FormControl<DeviceFormRawValue['idIsland']>;
  idCurrencyType: FormControl<DeviceFormRawValue['idCurrencyType']>;
};
...
export class DeviceFormService {
  createDeviceFormGroup(device: DeviceFormGroupInput = { id: null }): DeviceFormGroup {
    ...
    return new FormGroup<DeviceFormGroupContent>({
      ...
      idInterfacing: new FormControl(deviceRawValue.idInterfacing, {
        validators: [Validators.required],
      }),
      idModel: new FormControl(deviceRawValue.idModel, {
        validators: [Validators.required],
      }),
      idDeviceCategory: new FormControl(deviceRawValue.idDeviceCategory, {
        validators: [Validators.required],
      }),
      idDeviceType: new FormControl(deviceRawValue.idDeviceType, {
        validators: [Validators.required],
      }),
      idFormulaHandpay: new FormControl(deviceRawValue.idFormulaHandpay),
      idFormulaJackpot: new FormControl(deviceRawValue.idFormulaJackpot),
      idIsland: new FormControl(deviceRawValue.idIsland),
      idCurrencyType: new FormControl(deviceRawValue.idCurrencyType),
    });
  }
