...
type DeviceFormGroupContent = {
  ...
  interfacing: FormControl<DeviceFormRawValue['interfacing']>;
  ...
  island: FormControl<DeviceFormRawValue['island']>;
  urrencyType: FormControl<DeviceFormRawValue['urrencyType']>;
};
...
export class DeviceFormService {
  createDeviceFormGroup(device: DeviceFormGroupInput = { id: null }): DeviceFormGroup {
    ...
    return new FormGroup<DeviceFormGroupContent>({
      ...
      interfacing: new FormControl(deviceRawValue.interfacing, {
        validators: [Validators.required],
      }),
      ...
      island: new FormControl(deviceRawValue.island),
      urrencyType: new FormControl(deviceRawValue.urrencyType),
    });
  }
