...
export class DeviceUpdateComponent implements OnInit {
  ...
  protected updateForm(device: IDevice): void {
    ...
    this.islandsSharedCollection = this.islandService.addIslandToCollectionIfMissing<IIsland>(this.islandsSharedCollection, device.island);
  ...
  protected loadRelationshipsOptions(): void {
    this.interfacingService
      ...
      .pipe(
        map((interfacings: IInterfacing[]) =>
          this.interfacingService.addInterfacingToCollectionIfMissing<IInterfacing>(interfacings, this.device?.interfacing)
        )
      )
    ...
    this.islandService
      ...
      .pipe(map((islands: IIsland[]) => this.islandService.addIslandToCollectionIfMissing<IIsland>(islands, this.device?.island)))
    ...
    this.currencyTypeService
      ...
      .pipe(
        map((currencyTypes: ICurrencyType[]) =>
          this.currencyTypeService.addCurrencyTypeToCollectionIfMissing<ICurrencyType>(currencyTypes, this.device?.urrencyType)
        )
      )
