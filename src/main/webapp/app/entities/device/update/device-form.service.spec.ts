      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            idInterfacing: expect.any(Object),
            idModel: expect.any(Object),
            idDeviceCategory: expect.any(Object),
            idDeviceType: expect.any(Object),
            idFormulaHandpay: expect.any(Object),
            idFormulaJackpot: expect.any(Object),
            idIsland: expect.any(Object),
            idCurrencyType: expect.any(Object),
          })
        );
      });
