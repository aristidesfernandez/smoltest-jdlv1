    ...
    this.counterTypeService
      ...
      .pipe(
        map((counterTypes: ICounterType[]) =>
          this.counterTypeService.addCounterTypeToCollectionIfMissing<ICounterType>(counterTypes, this.counterEvent?.counterCode)
        )
      )
    ...
    this.eventDeviceService
      ...
      .pipe(
        map((eventDevices: IEventDevice[]) =>
          this.eventDeviceService.addEventDeviceToCollectionIfMissing<IEventDevice>(eventDevices, this.counterEvent?.idEventDevice)
        )
      )
