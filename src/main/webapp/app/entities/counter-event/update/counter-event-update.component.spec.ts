...
describe('CounterEvent Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call CounterType query and add missing value', () => {
      ...
      const counter: ICounterType = { counterCode: '55' };
      counterEvent.counter = counter;

      const counterTypeCollection: ICounterType[] = [{ counterCode: 'e5' }];
    ...
    it('Should update editForm', () => {
      const counterEvent: ICounterEvent = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const counter: ICounterType = { counterCode: '79' };
      counterEvent.counter = counter;
