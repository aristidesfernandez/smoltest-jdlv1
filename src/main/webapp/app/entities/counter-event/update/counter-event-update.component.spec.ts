...
describe('CounterEvent Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call CounterType query and add missing value', () => {
      ...
      const counterCode: ICounterType = { counterCode: '55a665f7-3873-404f-bd07-b7ff79ae29b2' };
      counterEvent.counterCode = counterCode;

      const counterTypeCollection: ICounterType[] = [{ counterCode: 'aaf9878e-8b1b-4e0c-8bf5-a13fbc98b12e' }];
    ...
    it('Should call EventDevice query and add missing value', () => {
      const counterEvent: ICounterEvent = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const idEventDevice: IEventDevice = { id: 'b63e03bf-3576-4022-8bad-75db93751509' };
    ...
    it('Should update editForm', () => {
      const counterEvent: ICounterEvent = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const counterCode: ICounterType = { counterCode: 'e581f87a-e3bb-4f21-a017-f563b095e730' };
      counterEvent.counterCode = counterCode;
      const idEventDevice: IEventDevice = { id: '3b962c5b-3633-4292-b6a3-8b4c68246c4e' };
      counterEvent.idEventDevice = idEventDevice;
