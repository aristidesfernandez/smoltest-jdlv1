...
type OperationalPropertiesEstablishmentFormGroupContent = {
  ...
  key: FormControl<IOperationalPropertiesEstablishment['key']>;
  idEstablishment: FormControl<IOperationalPropertiesEstablishment['idEstablishment']>;
};
...
export class OperationalPropertiesEstablishmentFormService {
  createOperationalPropertiesEstablishmentFormGroup(
    ...
    return new FormGroup<OperationalPropertiesEstablishmentFormGroupContent>({
      ...
      key: new FormControl(operationalPropertiesEstablishmentRawValue.key),
      idEstablishment: new FormControl(operationalPropertiesEstablishmentRawValue.idEstablishment, {
        validators: [Validators.required],
      }),
    });
  }
